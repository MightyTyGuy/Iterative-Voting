    ...
    for gen in gens:
        for num_voters in voters:
            for num_cands in cands:
                ...
                borda_avg = [{'learn': 0, 'bestres': 0, 'bayes': 0, 'learnbr': 0, 'prag': 0} for _ in range(num_reps)]
                cond_avg = [{'learn': 0, 'bestres': 0, 'bayes': 0, 'learnbr': 0, 'prag': 0} for _ in range(num_reps)]
                ...
                for rep in range(num_reps):
                    exp = experiment(util, gen, num_cands, num_voters, exp_num, rep, num_iters, alpha)
                    isCond = exp._isCond
